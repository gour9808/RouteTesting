export class Constants {
    public static BASE_URL = "https://ap5.salesforce.com/services/data/v35.0/tooling/query/?q=SELECT id%2C Application%2C Operation%2C Status%2C DurationMilliseconds%2C LogLength%2C StartTime%2C LogUser.Name from ApexLog where  ";
