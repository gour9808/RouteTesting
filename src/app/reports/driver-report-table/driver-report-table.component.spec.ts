...
import { DriverReportTableComponent } from './driver-report-table.component';
...
describe('DriverReportTableComponent', () => {

    let component: DriverReportTableComponent;
    let fixture: ComponentFixture<DriverReportTableComponent>;
    ...
    beforeEach(async(() => {
        ...
        fixture = TestBed.createComponent(DriverReportTableComponent);
